...
//     _ = &a;
//     var b: usize = @intFromPtr(&@as(*allowzero struct_B, @ptrFromInt(0))._data);
//     _ = &b;
//     var c: usize = @intFromPtr(&@as(*allowzero struct_C, @ptrFromInt(0))._data);
//     _ = &c;
//     var d: usize = @intFromPtr(&@as(*allowzero struct_D, @ptrFromInt(0))._data);
//     _ = &d;
// }
